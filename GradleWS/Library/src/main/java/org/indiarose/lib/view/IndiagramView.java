...
public class IndiagramView extends View implements OnTouchListener
{
	...
	{
		return AppData.settings.indiagramSize / 10 * 2 + AppData.settings.indiagramSize + AppData.settings.fontSize * (((AppData.settings.fontSize*25/AppData.settings.indiagramSize)/2)+1);
	}
}
