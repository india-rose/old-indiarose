...
public class CalendarPickerView extends ListView {
	...
	List<MonthView> lesMois = new ArrayList<MonthView>();

	List<Date> datesAColorier = new ArrayList<Date>();
	int couleurJours = Color.YELLOW;
	...
	public void fixDialogDimens() {
		Logr.d("Fixing dimensions to h = %d / w = %d", getMeasuredHeight(),
				getMeasuredWidth());
	...
	private class MonthAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			monthView.afficherJours(CalendarPickerView.this.datesAColorier,
					CalendarPickerView.this.couleurJours);
