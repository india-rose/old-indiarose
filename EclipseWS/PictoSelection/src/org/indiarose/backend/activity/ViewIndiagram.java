...
public class ViewIndiagram extends VoiceActivity implements OnClickListener{
	...
	protected void refresh()
	{
		...
		{
			m_indiagramSound.setText(AppData.currentContext.getString(R.string.indiagramNoSound));
		}
		else
		{
		...
		{
			Log.wtf("ViewIndiagram", "unable to load image : " + m_indiagram.imagePath, e);
		}
	...
	public void onClick(View v) {
		...
		case R.id.deleteButton :
			delete();
			i = new Intent(this,CollectionManagement.class);
			startActivity(i);
			break;
	...
	private void delete(){
		if(m_indiagram instanceof Category)
		{
			...
			{
				Toast.makeText(this, R.string.canNotDeleteCategory, Toast.LENGTH_LONG).show();
			}
		}
		else{
