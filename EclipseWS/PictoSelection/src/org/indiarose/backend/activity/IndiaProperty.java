...
public class IndiaProperty extends Activity implements OnCheckedChangeListener, OnClickListener {
	...
	protected void createSpinner()
	{
		...
		ArrayAdapter<String> fontSizeAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item);
		...
		{
			int size = (int)((imageSizes[i] / 10 * 2 + imageSizes[i] + AppData.settings.fontSize) * 1.2);
			if(size < this.leftLayout.getHeight() / 3)
			{
